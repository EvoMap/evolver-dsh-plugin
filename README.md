...
| `assetPrimeMinSimilarity` | `0.5` | Lowest search similarity worth injecting. Titles read as relevant far below this; measured on a live Hub, a usable match scores 0.88–0.96 while boilerplate and off-topic hits score 0.19–0.22. A Proxy that reports no score is not filtered. |
